    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white pt-20">
        <div>
          ...
          <p className="py-3">
            Estas son las tecnologias con las que he trabajado / These are the
            technologies I've worked with
          </p>
        </div>
        <div className="w-full grid grid-cols-3 sm:grid-cols-3 gap-4 text-center py-4 px-12 sm:px-0">
